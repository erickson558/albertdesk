...
5. Versión coherente `V1.3.2` en `main.py`, `albertdesk/__init__.py`, `setup.py`,
   `README.md`, `CHANGELOG.md` y tag de git.
...
- **Republicar tags `V1.3.0`/`V1.3.1` a origin**: quedaron como hitos de desarrollo
  local nunca liberados; se documentan en el CHANGELOG pero solo se publica el tag
  consolidado `V1.3.2` para evitar 3 GitHub Releases redundantes de versiones que
